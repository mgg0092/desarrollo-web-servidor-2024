    ...
    <div class="container">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            <div class="mb-3">
                ...
                <input class="form-control" name="titulo" type="text" value="<?php echo $anime["titulo"] ?>">
            </div>
            <div class="mb-3">
                <label class="form-label">Estudio</label>
                <select name="nombre_estudio" class="form-select">
                <option value="<?php echo $anime["nombre_estudio"] ?>" selected >-</option>
                    <?php
            ...
            <div class="mb-3">
                ...
                <input class="form-control" name="anno_estreno" type="text" value="<?php echo $anime["anno_estreno"] ?>">
            </div>
            <div class="mb-3">
                <label class="form-label">Número temporadas</label>
                <input class="form-control" name="num_temporadas" type="text" value="<?php echo $anime["num_temporadas"] ?>">
            </div>
            <div class="mb-3">
